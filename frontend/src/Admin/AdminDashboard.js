        ...
        <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark'>
          <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
            ...
            <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start' id='menu'>
              <li className={`nav-item w-100 ${location.pathname === '/admin/dashboard1' ? 'bg-dark' : ''}`}>
                <Link to="/admin/dashboard1" className='nav-link px-0 align-middle'>
              ...
              <li className={`nav-item w-100 ${location.pathname === '/Admin/AdminAttendance' ? 'bg-dark' : ''}`}>
                <Link to="/Admin/AdminAttendance" className='nav-link px-0 align-middle text-white'>
